...
ขั้นที่ 1 เริ่มได้ก่อนมี Auth0 แต่ขั้นเชื่อมต่อจริงต้องมีค่าบัญชีของผู้พัฒนา การตั้งค่าบริการยังไม่เกิดขึ้นและไม่มีการอ้างว่า auth ผ่านแล้ว
...
ผู้พัฒนายืนยันใน Q15 แล้ว เริ่มขั้นที่ 1 ตามแผนได้ ไม่ต้องเปิดคำถามที่ตกลงแล้วซ้ำ ขั้น Auth/Collections และแบบฝึก Bookmarks ยังเป็นช่วงถัดไป
